...
INSERT INTO videos
    (title, videourl, rating)
VALUES
    ('The Complete London 2012 Opening Ceremony | London 2012 Olympic Games', 'https://www.youtube.com/watch?v=4As0e4de-rI', 3211);
INSERT INTO videos
    (title, videourl, rating)
VALUES
...
INSERT INTO videos
    (title, videourl, rating)
VALUES
    ('Coding Adventure:Chess AI', 'https://www.youtube.com/watch?v=X-iSQQgOd1A', 76);
INSERT INTO videos
    (title, videourl, rating)
VALUES
