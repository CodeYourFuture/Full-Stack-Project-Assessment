(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../AnimatableColor", "../AnimatableGradient", "./Collisions/Collisions", "./Destroy/Destroy", "./Life/Life", "./Links/Links", "./Move/Move", "./Opacity/Opacity", "./Orbit/Orbit", "./Bounce/ParticlesBounce", "./Number/ParticlesNumber", "./Repulse/ParticlesRepulse", "./Roll/Roll", "./Rotate/Rotate", "./Shadow", "./Shape/Shape", "./Size/Size", "./Stroke", "./Tilt/Tilt", "./Twinkle/Twinkle", "./Wobble/Wobble", "./ZIndex/ZIndex", "../../../Utils/Utils"], factory);
    }
