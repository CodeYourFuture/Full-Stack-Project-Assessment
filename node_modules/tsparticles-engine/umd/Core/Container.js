...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Utils/Utils", "./Canvas", "./Utils/EventListeners", "./Utils/FrameManager", "./Particles", "./Retina", "../Utils/NumberUtils"], factory);
    }
    ...
    class Container {
        constructor(engine, id, sourceOptions) {
            ...
            this.density = 1;
            this._options = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"));
            this.actualOptions = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"));
        ...
        async init() {
            ...
            this._options = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this._initialSourceOptions, this.sourceOptions);
            this.actualOptions = (0, Utils_1.loadContainerOptions)(__classPrivateFieldGet(this, _Container_engine, "f"), this._options);
            this.retina.init();
            this.canvas.init();
